...
function HeroSection() {
  return (
    <div className="relative w-full h-screen bg-cover bg-center flex flex-col justify-center items-center text-center text-white"
      style={{ backgroundImage: "url('https://source.unsplash.com/1600x900/?grocery,market')" }}>
      ...
      <div className="relative z-10">
        ...
        <p className="mt-4 text-xl text-gray-200 max-w-2xl">Find and buy near-expiry products at discounted prices while saving the environment.</p>
